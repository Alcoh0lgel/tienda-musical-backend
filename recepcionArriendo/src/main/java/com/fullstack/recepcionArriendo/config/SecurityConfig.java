package com.fullstack.recepcionArriendo.config;

import com.fullstack.recepcionArriendo.security.JwtAuthenticationsFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/recepcionArriendo/publico").permitAll()
